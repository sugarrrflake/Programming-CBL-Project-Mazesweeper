...
public class SettingsScreen {
    ...
    StartButtonEventHandler2 startListener = new StartButtonEventHandler2();

    JTextField seedInputField = new JTextField(19);
    JLabel invalidSeedLabel = new JLabel();
    JSlider difficultySlider = new JSlider(1, 6);
    ...
    public SettingsScreen() {
        ...
        frame.setSize(Menu.frameWidth, Menu.frameHeight);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setResizable(false);
        // Setup of background image
        try {
            final Image MazesweeperBackground = ImageIO.read(new File("MazesweeperTiles.png")); //TODO make this the new image
